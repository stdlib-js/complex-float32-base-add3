...
// The function returns a complex number...
{
	...
	add3( z, z, z ); // $ExpectType Complex64
}
...
// Attached to the main export is a `strided` method which returns a collection...
{
	...
	const z3 = new Float32Array( z1.length );
...
// The compiler throws an error if the `strided` method is provided a seventh argument which is not a collection...
{
	...
	add3.strided( z1, 1, 0, z2, 1, 0, true, 1, 0, out, 1, 0 ); // $ExpectError
	add3.strided( z1, 1, 0, z2, 1, 0, false, 1, 0, out, 1, 0 ); // $ExpectError
	add3.strided( z1, 1, 0, z2, 1, 0, null, 1, 0, out, 1, 0 ); // $ExpectError
	add3.strided( z1, 1, 0, z2, 1, 0, undefined, 1, 0, out, 1, 0 ); // $ExpectError
	add3.strided( z1, 1, 0, z2, 1, 0, '5', 1, 0, out, 1, 0 ); // $ExpectError
	add3.strided( z1, 1, 0, z2, 1, 0, [ '5' ], 1, 0, out, 1, 0 ); // $ExpectError
	add3.strided( z1, 1, 0, z2, 1, 0, {}, 1, 0, out, 1, 0 ); // $ExpectError
	add3.strided( z1, 1, 0, z2, 1, 0, ( x: number ): number => x, 1, 0, out, 1, 0 ); // $ExpectError
}
