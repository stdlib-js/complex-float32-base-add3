...
/**
* Interface for summing three single-precision complex floating-point numbers.
*/
interface Add {
	/**
	...
	*/
	( z1: Complex64, z2: Complex64, z3: Complex64 ): Complex64;
	...
	*
	* var out = add.strided( z1, 1, 0, z2, 1, 0, z3, 1, 0, new Float32Array( 2 ), 1, 0 );
	* // returns <Float32Array>[ 15.0, 9.0 ]
	*/
