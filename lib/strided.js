...
* @param {Float32Array} z3 - third complex number view
...
*
* var out = strided( z1, 1, 0, z2, 1, 0, z3, 1, 0, new Float32Array( 2 ), 1, 0 );
...
function strided( z1, strideZ1, offsetZ1, z2, strideZ2, offsetZ2, z3, strideZ3, offsetZ3, out, strideOut, offsetOut ) { // eslint-disable-line max-len, max-params
	out[ offsetOut ] = f32( z1[ offsetZ1 ] + f32( z2[ offsetZ2 ] + z3[ offsetZ3 ] ) ); // eslint-disable-line max-len
	out[ offsetOut+strideOut ] = f32( z1[ offsetZ1+strideZ1 ] + f32( z2[ offsetZ2+strideZ2 ] + z3[ offsetZ3+strideZ3 ] ) ); // eslint-disable-line max-len
	return out;
}
