...
tape( 'the function sums three complex numbers', function test( t ) {
	...
	z3 = new Complex64( 5.0, 3.0 );

	v = add3( z1, z2, z3 );

	t.strictEqual( realf( v ), 8.0, 'returns expected value' );
	t.strictEqual( imagf( v ), 7.0, 'returns expected value' );
