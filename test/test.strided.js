...
tape( 'the function sums three complex numbers', function test( t ) {
	...
	z3 = new Float32Array( [ 5.0, 3.0 ] );
	out = new Float32Array( 2 );
	v = strided( z1, 1, 0, z2, 1, 0, z3, 1, 0, out, 1, 0 );

	expected = new Float32Array( [ 8.0, 7.0 ] );
	...
	expected = new Float32Array( [ 8.0, 0.0, 7.0, 0.0 ] );
	...
	expected = new Float32Array( [ 0.0, 8.0, 0.0, 7.0 ] );
	...
	z3 = new Float32Array( [ 3.0, 5.0 ] );
	out = new Float32Array( 4 );
	v = strided( z1, -1, 1, z2, -1, 1, z3, -1, 1, out, -2, 3 );

	expected = new Float32Array( [ 0.0, 7.0, 0.0, 8.0 ] );
...
tape( 'if a real or imaginary component is `NaN`, the output component is `NaN`', function test( t ) {
	...
	z3 = new Float32Array( [ 5.0, 3.0 ] );
	out = new Float32Array( 2 );
	expected = new Float32Array( [ NaN, 7.0 ] );
	...
	z3 = new Float32Array( [ 5.0, 3.0 ] );
	out = new Float32Array( 2 );
	expected = new Float32Array( [ 8.0, NaN ] );
